...
func setupUINavigationControllerSwizzling(isEnabled: Bool, showMargins: Bool) {
    ...
    _ = try? $0.prepareHook(
      ...
      { nc in
        ...
        if isEnabled {
          ...
          nc.additionalSafeAreaInsets.top = (statusBarHeight - figmaStatusBarHeight) + topPadding
        }
